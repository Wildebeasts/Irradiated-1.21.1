...
public class JetItem extends Item {
	private final int useTime;

	public JetItem(Properties properties, int useTime) {
		super(properties);
	...
	public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entity) {
		...
		level.playSound(null, entity.getX(), entity.getY(), entity.getZ(), 
				ModSounds.JET.get(), SoundSource.PLAYERS, 1.0F, 1.0F);
		...
		// Jet gives speed boost but also chem sickness
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
		tooltipComponents.add(Component.translatable("info.irradiated.jet").withStyle(ChatFormatting.GRAY));
