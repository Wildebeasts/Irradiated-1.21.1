...
public class CateyeItem extends Item {
	...
	public CateyeItem(Properties properties, int useTime) {
		super(properties);
	...
	public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entity) {
		...
		// Cateye provides night vision but also chem sickness
		entity.addEffect(new MobEffectInstance(MobEffects.NIGHT_VISION, 6000, 0, true, false));
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
		tooltipComponents.add(Component.translatable("info.irradiated.cateye").withStyle(ChatFormatting.GRAY));
