...
public class PsychoItem extends Item {
	...
	public PsychoItem(Properties properties, int useTime) {
		super(properties);
	...
	public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entity) {
		...
		// Psycho gives damage boost but also chem sickness
		entity.addEffect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 600, 0, true, false));
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
		tooltipComponents.add(Component.translatable("info.irradiated.psycho").withStyle(ChatFormatting.GRAY));
