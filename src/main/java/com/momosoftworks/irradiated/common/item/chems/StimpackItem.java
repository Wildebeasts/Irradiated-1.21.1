...
public class StimpackItem extends Item {
	...
	public StimpackItem(Properties properties, int useTime, float healAmount) {
		super(properties);
	...
	public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entity) {
		...
		// Instant health effect and chem sickness (no direct healing)
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
		tooltipComponents.add(Component.translatable("info.irradiated.stimpack").withStyle(ChatFormatting.GRAY));
