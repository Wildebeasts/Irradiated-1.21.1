...
public class MedxItem extends Item {
	...
	public MedxItem(Properties properties, int useTime) {
		super(properties);
	...
	public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entity) {
		...
		level.playSound(null, entity.getX(), entity.getY(), entity.getZ(), 
				ModSounds.STIMPACK.get(), SoundSource.PLAYERS, 1.0F, 1.0F);
		...
		// MedX gives damage resistance but also chem sickness
		entity.addEffect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 300, 1, false, true));
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
		tooltipComponents.add(Component.translatable("info.irradiated.medx").withStyle(ChatFormatting.GRAY));
